...
class Task2{
	public static void main(String[]args) {
		...
		Author author1=new Author("Robert Lafore","lafore.robert@outlook.com",'M');
		Author author2=new Author("Muhammad Usama","muhammadusamashaikh110@gmail.com",'M');
		Author[] authors={author1,author2};
		Book b1=new Book("C++",authors,300.5,5);
